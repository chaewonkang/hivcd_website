...
const HeaderTitle = () => {
	return (
		...
		<div class="container-fluid">
		  <div class="row">
			<div class="header__title-col col-sm-8">
			  <h1><a class="blank-link" href="/en/">Hongik University Visual Communication Design 홍익대학교 시각디자인과</a></h1>
			</div>
			<div class="header__search-col col-sm-4">
			  <div class="header__search-form">
				...
				<div class="search-form">
				  <form class="search-form__form" action="/en/search" accept-charset="UTF-8" data-remote="true" method="post"><input name="utf8" type="hidden" value="&#x2713;" />
