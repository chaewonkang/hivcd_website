...
import image from '../../img/archive_ex.png'
import './HomeArchive.css'

const HomeArchive = () => (
	<div className="archive col-lg-12">
		...
		<div className="container-fluid">
			<div className="row">
				<div className="archive_content col-lg-8">
					<h2 className="archive_content_header">2018 시각디자인과 졸업주간<br></br>
					...
					2018. 12. 3 – 8 <br></br>
					홍문관 1층, 7층 <br></br>
					R Floor 2, Floor 7</h2>
					<span className="archive_content_date"></span>
				</div>
				<div className="archive_image col-lg-4 image_fill">
				</div>
			</div>
		</div>
	</div>
